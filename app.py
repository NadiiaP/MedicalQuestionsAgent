...
def load_data():
    with st.spinner(text="Loading and indexing Medical Health docs – hang tight! This should take 3-5 minutes."):
        reader = SimpleDirectoryReader(input_dir="/Users/nadiiapoliakovska/Downloads/data", recursive=True)
        ...
        index = VectorStoreIndex(docs, base_nodes, embed_model=embed_model, service_context=service_context)
